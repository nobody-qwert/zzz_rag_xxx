...
const styles = {
  ...
  messages: { minHeight: 280, maxHeight: "55vh", overflow: "auto", border: "1px solid rgba(148, 163, 184, 0.12)", borderRadius: 16, padding: 18, background: "rgba(9, 11, 18, 0.78)", whiteSpace: "pre-wrap", display: "flex", flexDirection: "column", gap: 12 },
  messageList: { display: "flex", flexDirection: "column", gap: 12 },
  userBubble: { alignSelf: "flex-end", background: "rgba(59, 130, 246, 0.18)", border: "1px solid rgba(59, 130, 246, 0.35)", borderRadius: 16, padding: 12, maxWidth: "85%" },
  assistantBubble: { alignSelf: "flex-start", background: "rgba(84, 105, 255, 0.12)", border: "1px solid rgba(148, 163, 184, 0.25)", borderRadius: 16, padding: 12, maxWidth: "95%", lineHeight: 1.55 },
  errorBubble: { alignSelf: "flex-start", background: "rgba(239, 68, 68, 0.12)", border: "1px solid rgba(239, 68, 68, 0.4)", borderRadius: 16, padding: 12, maxWidth: "95%" },
  ...
  return (
    <div style={styles.page}>
      <section style={styles.chatCard}>
        ...
        {pendingFollowUp && (
          <div style={{ border: "1px solid rgba(248, 250, 252, 0.12)", borderRadius: 14, padding: 14, background: "rgba(24, 27, 40, 0.7)", display: "flex", flexDirection: "column", gap: 12 }}>
