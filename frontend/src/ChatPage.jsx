...
const styles = {
  ...
  chatCard: { flex: "2 1 540px", border: "1px solid rgba(148, 163, 184, 0.18)", borderRadius: 0, padding: "20px 24px", background: "rgba(13, 16, 24, 0.92)", boxShadow: "0 18px 32px rgba(2, 6, 23, 0.35)", display: "grid", gap: 16, alignContent: "start" },
  sideCard: { flex: "1 1 320px", border: "1px solid rgba(148, 163, 184, 0.18)", borderRadius: 0, padding: "20px 20px", background: "rgba(13, 16, 24, 0.88)", boxShadow: "0 14px 28px rgba(2, 6, 23, 0.32)", display: "grid", gap: 12, alignContent: "start", maxHeight: "calc(100vh - 220px)", overflow: "hidden" },
  ...
  button: { font: "inherit", padding: "8px 16px", borderRadius: 0, border: "1px solid rgba(84, 105, 255, 0.45)", background: "linear-gradient(135deg, rgba(84, 105, 255, 0.18), rgba(84, 105, 255, 0.05))", color: "#c7d7ff", cursor: "pointer" },
  subtleButton: { font: "inherit", padding: "6px 12px", borderRadius: 0, border: "1px solid rgba(148, 163, 184, 0.35)", background: "rgba(15, 17, 23, 0.6)", color: "rgba(226, 232, 240, 0.9)", cursor: "pointer" },
  input: { font: "inherit", padding: "10px 14px", borderRadius: 0, border: "1px solid rgba(148, 163, 184, 0.35)", background: "rgba(9, 11, 18, 0.82)", color: "inherit", flex: 1, minWidth: 0 },
  muted: { fontSize: 13, color: "rgba(148, 163, 184, 0.78)" },
  messages: { minHeight: 260, maxHeight: "50vh", overflow: "auto", border: "1px solid rgba(148, 163, 184, 0.12)", borderRadius: 0, padding: 14, background: "rgba(9, 11, 18, 0.78)", whiteSpace: "pre-wrap", display: "flex", flexDirection: "column", gap: 10 },
  messageList: { display: "flex", flexDirection: "column", gap: 10 },
  ...
  docs: { overflow: "auto", border: "1px solid rgba(148, 163, 184, 0.12)", borderRadius: 0, padding: 16, background: "rgba(9, 11, 18, 0.72)" },
